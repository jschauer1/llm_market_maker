...
---
FACTS. `theories/insider_bias/mention_family/studies/investigation/2026-08-29-series-bias-mining/collect.py backfill` is a multi-hour, resumable, per-series-atomic job against perishable upstream data (Kalshi ages settled markets out ~60 days after close). It has now stalled twice because the session running it ended:
