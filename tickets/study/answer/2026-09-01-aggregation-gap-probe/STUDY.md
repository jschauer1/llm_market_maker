---
title: The aggregation gap is spread, and its headline case is not the identity it claims
lane: study
created: 2026-09-01
...
See `RESULT.md` for the measurement and `output.txt` for its raw output.
