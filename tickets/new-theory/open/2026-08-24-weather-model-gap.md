---
title: Kalshi temperature markets settle on one NWS station, and public keyless ensembles forecast that exact station
lane: new-theory
created: 2026-08-24
...
`python -m tools.cli ideas search "weather-model-gap"` in case the status
