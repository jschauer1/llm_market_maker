...
**Date:** 2026-09-01 · **Status:** complete · **Tier:** A (no model in the
measurement path) · **Session:** `llm-market-identifier-57`, theory lane
...
`studies/2026-08-29-series-bias-mining/` holds **72,010 priced settled
...
```bash
cp studies/2026-08-29-series-bias-mining/data/collect.db /tmp/copy.db   # copy: a peer runs a multi-hour backfill on the live file
python studies/2026-09-01-side-split-60day-obs/measure.py /tmp/copy.db
```
