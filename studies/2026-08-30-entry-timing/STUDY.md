...
**Date:** 2026-08-30 · **Status:** complete — **result: FAILED PREDICTION**, and
the useful half is the secondary null ·
...
```bash
python studies/2026-08-30-entry-timing/counts.py  <collect.db>   # counts only
python studies/2026-08-30-entry-timing/measure.py <collect.db>   # as pre-registered (defective framing)
python studies/2026-08-30-entry-timing/orient.py  <collect.db>   # the correction
```
