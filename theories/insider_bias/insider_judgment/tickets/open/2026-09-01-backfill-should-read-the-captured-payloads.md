...
REUSE. studies/2026-09-01-early-close-exposure-in-the-bettable-slice/collect.py is ~90 lines, resumable (skips what is already in the file, flushes per ticker), and needs only its RUNS tuple changed.
