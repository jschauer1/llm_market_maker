...
status: open
---
The broad settled-history sweep (theories/insider_bias/mention_family/studies/investigation/2026-08-29-series-bias-mining/collect.py) is the prerequisite for every future pass of this study, and it is PARTIALLY DONE. Resume it with:
...
WHAT PASS 3 ALREADY IS. The analysis bar is pre-registered and committed in STUDY.md ("Pass 3 analysis bar", 2026-09-01) BEFORE any per-series number was computed, along with its robustness views and its size-truncation disclosure. The runner is theories/insider_bias/mention_family/studies/investigation/2026-08-29-series-bias-mining/pass3.py, fixture-tested in tests/test_series_bias_pass3.py. Re-running it after extending the sweep is one command.
