...
`theories/no_side_premium/studies/answer/2026-09-01-side-split-60day-obs/` found the pooled NO-minus-YES gap
...
live file and a long read risks locking it:
    ...
    python theories/no_side_premium/studies/answer/2026-09-01-liquidity-filtered-side-split/measure.py <copy.db>
"""
